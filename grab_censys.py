"""Upstream grab.py, kept verbatim for reference.

It runs a Censys search query and needs Censys API credentials, so it fails with
"No API ID or API secret configured" unless they are present. The rebuilt grab.py
replaces it. This file is unchanged from commit 7b03fd4.
"""
